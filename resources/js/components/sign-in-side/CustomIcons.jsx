...
export function DatSlimIcon() {
  return (
    <SvgIcon sx={{ height: 50, width: 150, display: 'flex', alignItems: 'center' }}>
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 150 50"
        width="150"
      ...
      >
        {/* Rooster's body */}
        <path
          d="M20 25c0-5 4-8 8-8s8 3 8 8-4 8-8 8-8-3-8-8Z"
          fill="#4876EE"
        />
        {/* Rooster's comb */}
        <path
          d="M27 15c2-4 5-6 7-6s5 2 5 6-3 6-5 6-4-2-7-6Z"
          fill="#FF6347"
        />
        {/* Rooster's beak */}
        <path
          d="M35 20l5 2-5 2v-4Z"
          fill="#FFD700"
        />
        {/* Text 'datSlim' */}
        <text
